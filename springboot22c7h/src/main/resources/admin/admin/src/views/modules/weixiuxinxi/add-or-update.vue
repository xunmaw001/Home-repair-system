	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="date" v-if="type!='info'" label="维修时间" prop="weixiushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-else-if="ruleForm.weixiushijian" label="维修时间" prop="weixiushijian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="select" v-if="type!='info'" label="维修账号" prop="weixiuzhanghao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-else-if="ruleForm.weixiuzhanghao" label="维修账号" prop="weixiuzhanghao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="textarea" v-if="type!='info'" label="简介" prop="jianjie">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else-if="ruleForm.jianjie" label="简介" prop="jianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-if="type!='info'"  label="维修内容" prop="weixiuneirong">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else-if="ruleForm.weixiuneirong" label="维修内容" prop="weixiuneirong">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.weixiuneirong = this.ruleForm.weixiuneirong.replace(reg,'../../../springboot22c7h/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
