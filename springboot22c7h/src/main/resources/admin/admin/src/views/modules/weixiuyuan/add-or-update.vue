	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="维修电话" prop="weixiudianhua">
					<el-input v-model="ruleForm.weixiudianhua" placeholder="维修电话" clearable  :readonly="ro.weixiudianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="维修电话" prop="weixiudianhua">
					<el-input v-model="ruleForm.weixiudianhua" placeholder="维修电话" readonly></el-input>
				</el-form-item>
			</template>
