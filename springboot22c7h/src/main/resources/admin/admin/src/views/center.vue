  ...
  <div :style='{"padding":"30px 0 0"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}'   v-if="flag=='yonghu'"  label="用户电话" prop="yonghudianhua">
          <el-input v-model="ruleForm.yonghudianhua"               placeholder="用户电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}'   v-if="flag=='yonghu'"  label="身份证号" prop="shenfenzhenghao">
          <el-input v-model="ruleForm.shenfenzhenghao"               placeholder="身份证号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}'   v-if="flag=='weixiuyuan'"  label="维修账号" prop="weixiuzhanghao">
          <el-input v-model="ruleForm.weixiuzhanghao" readonly              placeholder="维修账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}'   v-if="flag=='weixiuyuan'"  label="维修姓名" prop="weixiuxingming">
          <el-input v-model="ruleForm.weixiuxingming"               placeholder="维修姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-if="flag=='weixiuyuan'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-if="flag=='weixiuyuan'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}'   v-if="flag=='weixiuyuan'"  label="维修电话" prop="weixiudianhua">
          <el-input v-model="ruleForm.weixiudianhua"               placeholder="维修电话" clearable></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'weixiuyuan' ==this.flag && this.ruleForm.weixiudianhua&&(!isMobile(this.ruleForm.weixiudianhua))){
